...
const mockImprovements: Improvement[] = [
    {
        ...
        machine: { id: 'M01', name: 'Tornio A', department: 'Tornitura', costPerMinute: 0.8, status: 'Operativa' },
    ...
    },
    {
        ...
        machine: { id: 'M02', name: 'Fresa B', department: 'Fresatura', costPerMinute: 1.2, status: 'Operativa' },
    ...
    },
    {
        ...
        machine: { id: 'M03', name: 'Centro Lavoro C', department: 'Fresatura', costPerMinute: 1.5, status: 'Manutenzione' },
